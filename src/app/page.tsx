...
export default function Home() {
  ...
  return (
    <div className="bg-gunmetal text-white grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <Container title="Why Shortest Path?">
        ...
        <p className="text-left">Deep industry knowledge across technology and
          business management. Customized Solutions: We focus on creating
          solutions that are uniquely tailored to the needs of your
          business.
        </p>
        </div>
      </Container>
      <Container color="black" title="What We Do?">
        <div className="w-full sm:w-[800px] text-center mt-10">
        <ul className="list-disc pl-5 text-left space-y-4 mb-10">
          <li>
        <strong>Consulting:</strong> Comprehensive analysis and strategic advice to identify opportunities for improvement and growth.
          </li>
          <li>
        <strong>Project Management:</strong> Guiding complex projects from conception through to completion ensuring timelines, budgets, and specifications are met.
          </li>
          <li>
        <strong>Training and Support:</strong> Offering ongoing support and training to ensure sustainable success and adaptation to new systems and processes.
          </li>
        </ul>
        </div>
      </Container>
      <Container title="Contact" color="blackOlive">
        Container 4
      </Container>
      </main>
